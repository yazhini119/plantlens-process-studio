...
const solarInverterPanelLayout = buildLayout({
  ...
  insight: {
    title: 'Power conversion chain monitored from source to motor load',
    severity: 'Medium',
    confidence: '91%',
    origin: 'INV-301',
    affectedAssets: 'DCM-203, BAT-201, INV-301, VFD-401, MTR-501, PLC-701',
    nextSpread: 'Drive trip or motor load instability',
    whatIsHappening:
    ...
    whatCouldMakeThisWrong: ['wrong MFM polarity', 'open MCB/fuse', 'RS485 termination fault', 'motor load mismatch'],
    verifyNext: [
  ...
  alarms: [
    { name: 'Inverter Load High', tag: 'INV-301', value: '47%', nodeId: 'inv301' },
    { name: 'VFD Current Watch', tag: 'VFD-401', value: '3.8 A', nodeId: 'vfd401' },
    { name: 'Motor Vibration Watch', tag: 'MTR-501', value: '2.4 mm/s', nodeId: 'motor501' },
    { name: 'RS485 Healthy', tag: 'PLC-701', value: 'Online', nodeId: 'plc701' },
  ],
  causalSteps: [
  ...
  routes: [
    buildRoute({ id: 'dc-source-fuse', from: { nodeId: 'dcSource101', portId: 'outlet' }, to: { nodeId: 'dcFuse101', portId: 'inlet' }, medium: 'dc-power', state: 'active', segments: [[-7.6, 0.2, -3.12]] }),
    buildRoute({ id: 'dc-fuse-mcb', from: { nodeId: 'dcFuse101', portId: 'outlet' }, to: { nodeId: 'dcMcb101', portId: 'inlet' }, medium: 'dc-power', state: 'active', segments: [[-7.6, 0.2, -2.08]] }),
    buildRoute({ id: 'dc-mcb-charger', from: { nodeId: 'dcMcb101', portId: 'outlet' }, to: { nodeId: 'solarCharger101', portId: 'inlet' }, medium: 'dc-power', state: 'active', segments: [[-7.6, 0.22, -1.02]] }),
    buildRoute({ id: 'solar-charger-dcm', from: { nodeId: 'solarCharger101', portId: 'outlet' }, to: { nodeId: 'dcmSolar201', portId: 'inlet' }, medium: 'dc-power', state: 'active', segments: [[-7.0, 0.24, 0.28]] }),
    buildRoute({ id: 'dcm-solar-battery', from: { nodeId: 'dcmSolar201', portId: 'outlet' }, to: { nodeId: 'battery201', portId: 'chargeIn' }, medium: 'dc-power', state: 'active', segments: [[-5.86, 0.2, 0.78]] }),
    buildRoute({ id: 'ac-source-fuse', from: { nodeId: 'acMains101', portId: 'outlet' }, to: { nodeId: 'acFuse101', portId: 'inlet' }, medium: 'ac-power', state: 'active', segments: [[-3.7, 0.2, -3.12]] }),
    buildRoute({ id: 'ac-fuse-mcb', from: { nodeId: 'acFuse101', portId: 'outlet' }, to: { nodeId: 'acMcb101', portId: 'inlet' }, medium: 'ac-power', state: 'active', segments: [[-3.7, 0.2, -2.08]] }),
    buildRoute({ id: 'ac-mcb-charger', from: { nodeId: 'acMcb101', portId: 'outlet' }, to: { nodeId: 'mainsCharger101', portId: 'inlet' }, medium: 'ac-power', state: 'active', segments: [[-3.7, 0.22, -1.02]] }),
    buildRoute({ id: 'mains-charger-dcm', from: { nodeId: 'mainsCharger101', portId: 'outlet' }, to: { nodeId: 'dcmMains202', portId: 'inlet' }, medium: 'dc-power', state: 'active', segments: [[-4.24, 0.24, 0.28]] }),
    buildRoute({ id: 'dcm-mains-battery', from: { nodeId: 'dcmMains202', portId: 'outlet' }, to: { nodeId: 'battery201', portId: 'chargeIn' }, medium: 'dc-power', state: 'active', segments: [[-5.06, 0.2, 0.78]] }),
    buildRoute({ id: 'battery-fuse', from: { nodeId: 'battery201', portId: 'outlet' }, to: { nodeId: 'batteryFuse201', portId: 'inlet' }, medium: 'dc-power', state: 'active', segments: [[-4.44, 0.22, 1.84]] }),
    buildRoute({ id: 'fuse-mcb-inverter-feed', from: { nodeId: 'batteryFuse201', portId: 'outlet' }, to: { nodeId: 'batteryMcb201', portId: 'inlet' }, medium: 'dc-power', state: 'active' }),
    buildRoute({ id: 'mcb-dcm-battery', from: { nodeId: 'batteryMcb201', portId: 'outlet' }, to: { nodeId: 'dcmBattery203', portId: 'inlet' }, medium: 'dc-power', state: 'active' }),
    buildRoute({ id: 'dcm-inverter', from: { nodeId: 'dcmBattery203', portId: 'outlet' }, to: { nodeId: 'inv301', portId: 'dcIn' }, medium: 'dc-power', state: 'active' }),
    buildRoute({ id: 'inverter-acm', from: { nodeId: 'inv301', portId: 'acOut' }, to: { nodeId: 'acmInv301', portId: 'inlet' }, medium: 'ac-power', state: 'active' }),
    buildRoute({ id: 'acm-vfd', from: { nodeId: 'acmInv301', portId: 'outlet' }, to: { nodeId: 'vfd401', portId: 'acIn' }, medium: 'ac-power', state: 'active' }),
    buildRoute({ id: 'vfd-acm-motor', from: { nodeId: 'vfd401', portId: 'motorOut' }, to: { nodeId: 'acmMotor302', portId: 'inlet' }, medium: 'ac-power', state: 'active' }),
    buildRoute({ id: 'acm-motor-load', from: { nodeId: 'acmMotor302', portId: 'outlet' }, to: { nodeId: 'motor501', portId: 'powerIn' }, medium: 'ac-power', state: 'active' }),
    buildRoute({ id: 'dcm-solar-rs485', from: { nodeId: 'dcmSolar201', portId: 'rs485' }, to: { nodeId: 'rs485Bus601', portId: 'inlet' }, medium: 'rs485', state: 'active', style: { dashed: true }, segments: [[-4.6, 0.62, -0.66]] }),
    buildRoute({ id: 'dcm-mains-rs485', from: { nodeId: 'dcmMains202', portId: 'rs485' }, to: { nodeId: 'rs485Bus601', portId: 'inlet' }, medium: 'rs485', state: 'active', style: { dashed: true }, segments: [[-3.4, 0.62, -0.66]] }),
    buildRoute({ id: 'dcm-battery-rs485', from: { nodeId: 'dcmBattery203', portId: 'rs485' }, to: { nodeId: 'rs485Bus601', portId: 'inlet' }, medium: 'rs485', state: 'active', style: { dashed: true }, segments: [[-0.8, 0.62, -0.66]] }),
    buildRoute({ id: 'acm-inverter-rs485', from: { nodeId: 'acmInv301', portId: 'rs485' }, to: { nodeId: 'rs485Bus601', portId: 'outlet' }, medium: 'rs485', state: 'active', style: { dashed: true }, segments: [[1.76, 0.62, -0.66]] }),
    buildRoute({ id: 'vfd-rs485', from: { nodeId: 'vfd401', portId: 'rs485' }, to: { nodeId: 'rs485Bus601', portId: 'outlet' }, medium: 'rs485', state: 'active', style: { dashed: true }, segments: [[3.28, 0.62, -0.66]] }),
    buildRoute({ id: 'acm-motor-rs485', from: { nodeId: 'acmMotor302', portId: 'rs485' }, to: { nodeId: 'rs485Bus601', portId: 'outlet' }, medium: 'rs485', state: 'active', style: { dashed: true }, segments: [[4.72, 0.62, -0.66]] }),
    buildRoute({ id: 'bus-plc-rs485', from: { nodeId: 'rs485Bus601', portId: 'outlet' }, to: { nodeId: 'plc701', portId: 'rs485' }, medium: 'rs485', state: 'active', style: { dashed: true }, segments: [[3.6, 0.54, -1.28], [4.82, 0.54, -1.58]] }),
    buildRoute({ id: 'motor-temp-card', from: { nodeId: 'motor501', portId: 'sensorOut' }, to: { nodeId: 'tempCard701', portId: 'signalIn' }, medium: 'signal', state: 'active', style: { dashed: true }, segments: [[6.44, 0.64, 0.7], [5.72, 0.62, -0.02]] }),
    buildRoute({ id: 'temp-card-plc', from: { nodeId: 'tempCard701', portId: 'outlet' }, to: { nodeId: 'plc701', portId: 'sensorIn' }, medium: 'signal', state: 'active', style: { dashed: true } }),
    buildRoute({ id: 'plc-hmi', from: { nodeId: 'plc701', portId: 'hmi' }, to: { nodeId: 'hmi801', portId: 'rs485' }, medium: 'rs485', state: 'active', style: { dashed: true }, segments: [[6.72, 0.48, -2.06]] }),
  ],
  annotations: [
